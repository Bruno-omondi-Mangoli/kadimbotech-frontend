...
const contactInfo = [
  ...
  { icon: "📧", label: "Email", value: "info@kadimbotechsolutions.online" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="flex flex-col gap-5">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 p-4 rounded-xl text-white font-semibold text-sm transition-all hover:opacity-90"
              ...
              <div className="flex flex-col gap-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      style={{ borderColor: "var(--color-border-brand)", color: "var(--color-text-primary)" }}
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold mb-1.5" style={{ color: "var(--color-text-primary)" }}>
                      Email Address <span style={{ color: "var(--color-teal)" }}>*</span>
                    </label>
                    <input
                      type="email"
                      name="email"
                ...
                <div>
                  ...
                  <select
                    ...
                    value={form.subject}
                    onChange={handleChange}
                    className="w-full px-4 py-3 rounded-lg border text-sm outline-none transition-all focus:ring-2 bg-white"
                    style={{ borderColor: "var(--color-border-brand)", color: "var(--color-text-primary)" }}
                  >
                ...
                <div>
                  <label className="block text-sm font-semibold mb-1.5" style={{ color: "var(--color-text-primary)" }}>
                    Message <span style={{ color: "var(--color-teal)" }}>*</span>
                  </label>
                  <textarea
                    name="message"
                    value={form.message}
                ...
                <button
                  ...
                  className="w-full py-4 rounded-xl text-white font-semibold text-sm transition-all hover:opacity-90 disabled:opacity-60"
